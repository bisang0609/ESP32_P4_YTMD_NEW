...
void st7701_lcd::example_bsp_init_lcd_backlight()
{
    ...
    ESP_LOGI(TAG, "LCD Backlight PWM initialized on GPIO %d", EXAMPLE_PIN_NUM_BK_LIGHT);
#endif
}
...
void st7701_lcd::example_bsp_set_lcd_backlight(uint32_t level)
{
    ...
    // Convert to 10-bit duty cycle (0-1023)
...
{   
    ...
    // 创建JD9365控制面板 - Use portrait configuration for 480×800
    esp_lcd_dpi_panel_config_t dpi_config = ST7701_480_800_PORTRAIT_PANEL_60HZ_DPI_CONFIG(MIPI_DPI_PX_FORMAT);
   ...
   st7701_vendor_config_t vendor_config = {
    ...
    // 打开背光 - Set to 100% brightness
    example_bsp_set_lcd_backlight(100);
}
